export const labels: Record<string, string> = {
  ...
  ipReputation: 'label.ip-reputation',
  blocklisted: 'label.blocklisted',
  noMatch: 'label.no-match',
  unavailable: 'label.unavailable',
  allSources: 'label.all-sources',
  allConfidence: 'label.all-confidence',
  confidence: 'label.confidence',
  highConfidence: 'label.high-confidence',
  observations: 'label.observations',
  hits: 'label.hits',
  auditCsv: 'label.audit-csv',
  genericWafList: 'label.generic-waf-list',
  cloudflareCsv: 'label.cloudflare-csv',
